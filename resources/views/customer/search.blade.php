...
<div style="min-height:100vh; background:#F5F7FA; padding-bottom:80px;">
  ...
  <div style="background:linear-gradient(180deg, #0EA5E9 0%, #0284C7 100%); padding:16px; position:sticky; top:0; z-index:100;">
    ...
    <!-- Search Form -->
    <div style="position:relative;" id="page-search-wrapper">
      <form action="{{ url('/search') }}" method="GET" style="margin-bottom:0;" id="page-search-form">
...
<script>
  ...
  // Smooth Live Search on Normal Screen (Search Page)
  document.addEventListener('DOMContentLoaded', function() {
    ...
    searchInput.addEventListener('input', function() {
      ...
      const query = this.value; // Preserve exact characters & spaces
